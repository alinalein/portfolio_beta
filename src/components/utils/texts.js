const Texts = {
    en: {
        ...
        about: {
            title: "About me",
            welcomeText: "Welcome to my page, I am Alina. Some text about me will come soon.",
    ...
    de: {
        ...
        work: {
            ...
            projects: {
                ...
                chat: {
                    title: "React Native Chat",
                    description: "Diese App wurde für mobile Geräte mit React Native entwickelt. Sie bietet Benutzern eine Chat-Oberfläche und Optionen zum Chatten, Teilen von Bildern, Audios und ihrem Standort."
                },
                pokemon: {
                    title: "JavaScript Pokédex",
                    description: "Diese kleine Anwendung ruft Daten über Pokémon von einer externen API ab. Sie zeigt Details zu einem Pokémon an, wenn dessen Modal angeklickt wird, und ermöglicht es dem Benutzer, nach einem bestimmten Pokémon zu suchen."
                },
                api: {
                    title: "Node.JS Movie_API",
                    description: "Diese API gibt Benutzern Zugriff auf Details zu verschiedenen Filmen, Regisseuren und Genres. Benutzer können sich anmelden, ihre persönlichen Informationen aktualisieren, ihr Profil löschen und eine Liste ihrer Lieblingsfilme erstellen."
                },
                react: {
                    title: "React myFlix",
        ...
        about: {
            title: "Über mich",
            welcomeText: "Willkommen auf meiner Seite, ich bin Alina. Ein Text über mich wird bald folgen.",
            description: "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.",
